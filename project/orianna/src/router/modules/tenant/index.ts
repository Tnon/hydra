 ...
 * @LastEditTime: 2022-05-31 11:56:53
 */
...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    component: () =>
      import(/* webpackChunkName: "tenant-upload" */ '@/views/tenant/upload/index.vue'),
  },
  {
    path: 'overview',
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "tenant-sample" */ '@/views/tenant/sample/index.vue'),
  },
  {
    path: 'report',
    name: 'tenant-report',
    ...
    component: () =>
      import(/* webpackChunkName: "tenant-report" */ '@/views/tenant/sample/report/index.vue'),
  },
  {
    path: 'compress',
    ...
    component: () =>
      import(/* webpackChunkName: "tenant-compress" */ '@/views/tenant/sample/compress/index.vue'),
  },
  {
    path: 'memory',
    name: 'memory',
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "tenant-user" */ '@/views/tenant/user/index.vue'),
  },
  {
    path: 'config',
    name: 'tenant-config',
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "tenant-setting" */ '@/views/tenant/setting/index.vue'),
  },
];
