    ...
    <div class="content">
      ...
      <div class="datatable">
        ...
        <slots-table
          ...
          row-key="id"
          :arguments="agms"
          :get-list-func="getTenantZipList"
        />
      </div>
      <!-- 表格 end -->
    </div>
...
<script lang="ts">
  ...
  import { getTenantZipInfo, getTenantZipList } from '@/api/tenant/sample';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      //获取基本信息
      const getInfo = async () => {
        const { risk_value, sample_path_bak, ...res } = await getTenantZipInfo({
          id,
        });
