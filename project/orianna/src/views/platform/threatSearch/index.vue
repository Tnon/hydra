...
<template>
  <div class="container">
    ...
    <div class="left">
      ...
      <!-- 静态类情报 start -->
      <static-or-dynamic v-model:thirdparty="thirdparty" type="static" backgroundColor="white"/>
      <!-- 静态类情报 end -->
    ...
    <!-- 威胁情报查询 start -->
    <!-- <information-query class="left" ref="queryRef" v-model:inputValue="inputValue" /> -->
    <!-- 威胁情报查询 end -->
...
<script lang="ts" setup>
  ...
  import threatHotSearch from '@/components/threatHotSearch/index.vue';

  const inputValue = ref('');
  const queryRef = ref<any>();

  // 第三方情报，接收子组件传来的值,默认是0
...
<style lang="less" scoped>
  .container {
    ...
    .left {
      ...
      .threatQuery {
        // width: 100%; // 可加可不加
        height: auto; // 将查询内容区的高度显式的设为auto,否则背景色会部分失效
